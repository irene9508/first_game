...
class Entity:
    def __init__(self, game):
        ...
        self.coll_rect_trigger = pygame.Rect(0, 0, 0, 0)
        self.game = game
        ...
        if self.game.debugging:
            ...
            if self.trigger:
                pygame.draw.rect(surface, (255, 0, 255),
                                 (int(self.x + self.coll_rect_trigger.x),
                                  int(self.y + self.coll_rect_trigger.y),
                                  self.coll_rect_trigger.width,
                                  self.coll_rect_trigger.height), 1)
